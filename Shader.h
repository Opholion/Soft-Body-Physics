...
constexpr int ShaderCount = 3;
// Vertex and pixel shader DirectX objects
extern ID3D11VertexShader* gPixelLightingVertexShader[ShaderCount];
extern ID3D11PixelShader*  gPixelLightingPixelShader[ShaderCount];
