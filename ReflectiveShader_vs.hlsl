...
// be rendered. 
LightingPixelShaderInput main(CubeMapVertex modelVertex)
{
    ...
    //
    //output.projectedPosition = mul(modelPosition, gProjectionMatrix ).xyww;
    ...
    output.uvw = modelVertex.uvw;

   // output.uvw = float3(modelVertex.uvw * viewPosition);
